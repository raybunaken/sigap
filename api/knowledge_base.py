...
SKILL_SYNONYMS = {
    ...
    "machine learning":     ["ml", "ai", "artificial intelligence", "deep learning", "nlp", "natural language processing",
                             "llm", "large language model", "large language models", "generative ai", "gen ai",
                             "gpt", "chatgpt", "prompt engineering", "rag", "transformers",
                             "scikit", "scikit-learn", "model deployment"],
